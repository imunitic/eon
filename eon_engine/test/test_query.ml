...
let position_cmp = component "Position"
let velocity_cmp = component "Velocity"
let health_cmp = component "Health"
let frozen_cmp = component "Frozen"

(** Helper to create a world with registered components *)
let create_world_with_components () =
  let world = World.create () in
  (* Register some test components *)
  ignore (World.register world position_cmp);
  ignore (World.register world velocity_cmp);
  ignore (World.register world health_cmp);
  ignore (World.register world frozen_cmp);
  world
...
let test_iter1 () =
  ...
  World.add_component world e1 position_cmp { x = 1.0; y = 2.0 };

  let e2 = World.create_entity world in
  World.add_component world e2 position_cmp { x = 3.0; y = 4.0 };

  (* Create entity without Position *)
  let e3 = World.create_entity world in
  World.add_component world e3 health_cmp { current = 100; max = 100 };
...
let test_iter2 () =
  ...
  let e1 = World.create_entity world in
  World.add_component world e1 position_cmp { x = 1.0; y = 2.0 };
  World.add_component world e1 velocity_cmp { dx = 0.5; dy = 0.5 };
  ...
  let e3 = World.create_entity world in
  World.add_component world e3 velocity_cmp { dx = 1.0; dy = 1.0 };
...
let test_iter1_with_having () =
  ...
  let e1 = World.create_entity world in
  World.add_component world e1 position_cmp { x = 1.0; y = 2.0 };
  World.add_component world e1 frozen_cmp { value = true };
...
let test_count () =
  ...
  for i = 1 to 3 do
    ...
    World.add_component world e position_cmp { x = float i; y = float i }
  done;

  (* Create 1 entity without Position *)
  let e = World.create_entity world in
  World.add_component world e health_cmp { current = 100; max = 100 };
...
let test_unregistered_component () =
  ...
  let e = World.create_entity world in
  World.add_component world e position_cmp { x = 1.0; y = 2.0 };
...
let test_having_all () =
  ...
  let e2 = World.create_entity world in
  World.add_component world e2 position_cmp { x = 3.0; y = 4.0 };
  World.add_component world e2 velocity_cmp { dx = 1.0; dy = 1.0 };

  (* Create entity with Position only *)
  let e3 = World.create_entity world in
  World.add_component world e3 position_cmp { x = 5.0; y = 6.0 };
...
let test_not_having_any () =
  ...
  let e2 = World.create_entity world in
  World.add_component world e2 position_cmp { x = 3.0; y = 4.0 };
  World.add_component world e2 health_cmp { current = 100; max = 100 };
...
let test_iter3 () =
  ...
  World.add_component world e1 position_cmp { x = 1.0; y = 2.0 };
  World.add_component world e1 velocity_cmp { dx = 0.5; dy = 0.5 };
  World.add_component world e1 health_cmp { current = 100; max = 100 };
...
let test_iter4 () =
  ...
  World.add_component world e2 position_cmp { x = 3.0; y = 4.0 };
  World.add_component world e2 velocity_cmp { dx = 1.0; dy = 1.0 };
  World.add_component world e2 health_cmp { current = 50; max = 100 };
