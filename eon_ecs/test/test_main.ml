...
let () =
  run "Eon ECS Test Suite"
    [
      ...
      "Component Registry (QCheck)", Test_prop_component_registry.tests;
      "Component", Test_component.tests;
      "Resource Store", Test_resource_store.tests;
      "Resource Store (QCheck)", Test_prop_resource_store.tests;
